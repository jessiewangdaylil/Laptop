...
<link rel="stylesheet" href="{{asset('trip/style.css')}}">
...
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js'></script><script  src="{{asset('trip/script.js')}}"></script>
